...
\begin{itemize}
  ...
  \item 각 instance의 input/output 사이에 한 register boundary
...
23-bit unsigned \rtlfile{a<b} & 24 & 3 & 47 & 0 & magnitude compare \\
...
23-bit equality는 8 LUT와 2 CARRY4였다. unsigned magnitude compare는
bit의 우선순위를 판단해야 하므로 24 LUT와 3 CARRY4를 사용했다.
